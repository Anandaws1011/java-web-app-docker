node{
    ...
    stage('Build Docker Image'){
        sh 'docker build -t anandaws/java-web-app:51'
    }
    ...
    stage('Push Docker Image'){
        ...
        sh 'docker push anand2592/java-web-app:51'
     }
     
      stage('Run Docker Image In Dev Server'){
        
        def dockerRun = ' docker run  -d -p 8080:8080 --name java-web-app anandaws/java-web-app:51'
